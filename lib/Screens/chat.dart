...
import 'package:flutter_theme/CommonComponents/color.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:image_picker/image_picker.dart';
import 'package:intl/intl.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_theme/CommonComponents/CommonImage.dart';
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text(
          ...
          style: TextStyle(
              color: colors, fontWeight: FontWeight.bold, fontSize: 16),
        ),
        centerTitle: true,
      ),
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key key, @required this.pId, @required this.pImage})
      : super(key: key);
...
class ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  readLocal() async {
    ...
    Firestore.instance
        .collection('Enter your collection name') // Your collection name will be whatever you have given in firestore database 
        .document(id)
              ...
              children: <Widget>[
                document['type'] == 0
                    ...
                    ? Container(
                        ...
                        width: 220.0,
                        decoration: BoxDecoration(
                            color: bgcolors, borderRadius: borderRadius),
              ...
              children: <Widget>[
                ...
                document['type'] == 0
                    ? Container(
                        ...
                        width: 220.0,
                        decoration: BoxDecoration(
                            color: greyColor, borderRadius: leftborderRadius),
