...
import 'package:flutter_theme/Screens/Drawer.dart';
...
class _OTPScreenState extends State<OTPScreen> {
  ...
  PinDecoration _pinDecoration = UnderlineDecoration(
      enteredColor: Colors.black, hintText: '000000', color: Colors.black);
...
// DISSMISS KEYBOARD
  ...
  _homeNavigation(userid) async {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (context) => Drawerpage(currentUserId: userid)));
  }
