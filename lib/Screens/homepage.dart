...
import 'package:flutter_theme/Screens/chat.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter_theme/CommonComponents/BottomBar/bootom_navigation_bar.dart';
                  ...
                  if (!snapshot.hasData) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          loadUser(context, snapshot.data.documents[index]),
...
// LOAD USERDATA LIST
  ...
  Future<FirebaseUser> _fetch() async {
    ...
    final result = await Firestore.instance
        .collection('Enter you collection name here')
        .getDocuments();
